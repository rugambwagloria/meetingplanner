...
/**
	...
	public Calendar(){
		 ...
		 * Invalid dates will be caught by checkTimes() validation.
		 */
		...
		/** Invalid dates are now validated in checkTimes() immediately
		 * when any method is called, rather than using placeholder meetings.
		 * This throws TimeConflictException right away if month or day is invalid.
		 */
	}
